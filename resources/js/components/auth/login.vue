                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="" @submit.prevent="login">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn bg-white text-primary btn-block mt-5">Sign Me In</button>
                                        </div>
                                    </form>
                                                                        <div class="new-account mt-3">
                                                                            <p class="text-white">Don't have an account? <router-link to="/signup" class="text-white">Sign up</router-link></p>
                                                                        </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods:{
        login(){
            ...
            this.axios
                .post(this.$baseUrl + "/api/login", this.form)
                .then((response) => {
