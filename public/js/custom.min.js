var Qerza = function () {
    var e = $(window).width(), t = function () {
        ...
        e > 1024 && $(".metismenu  li").unbind().each(function (e) {
            if ($("ul", this).length > 0) {
                ...
                $("body").height();
                var o = $("body").width();
                if (jQuery("html").hasClass("rtl")) var s = n + a <= o; else var s = n > 0;
    ...
    return {
        init: function () {
            t(), n(), a(), o(), s(), i(), c(), l(), r(), d(), u(), h(), m(), f(), v(), p(), g(), b(), k(), C(), F(), z(), w(), y()
        }, load: function () {
            t(), n()
        }, resize: function () {
            y()
...
jQuery(document).ready(function () {
    ...
    "use strict";
    Qerza.load(), setTimeout(function () {
        Qerza.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function () {
    "use strict";
    Qerza.resize(), setTimeout(function () {
        Qerza.handleMenuPosition()
    }, 1e3)
});
